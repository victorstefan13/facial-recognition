...
FaceDetector::FaceDetector() : confidence_threshold_(0.5), input_image_height_(300), input_image_width_(300),
    ...
    static const std::string proto = "/Users/victorefrim/Documents/facial-recognition/assets/deploy.prototx";
    static const std::string model = "/Users/victorefrim/Documents/facial-recognition/assets/res10_300x300_ssd_iter_140000_fp16.caffemodel";
    network_ = cv::dnn::readNetFromCaffe(proto, model);

    if (network_.empty()) {
        std::ostringstream ss;
        ss << "Failed to load network with the following settings:\n"
           << "Configuration: " + std::string(proto) + "\n"
           << "Binary: " + std::string(model) + "\n";
